        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              <Card id="cookie-types" className="bg-gradient-to-br from-primary/5 to-accent/5 shadow-soft border-0 bg-background/80 backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 font-headline bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">
              ...
              {/* Quick Actions */}
              <Card className="bg-gradient-to-br from-accent/5 to-primary/5 shadow-soft border-0 bg-background/80 backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 font-headline bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">
