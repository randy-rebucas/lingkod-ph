  ...
  const successStories = [
    {
      ...
      quote: "Localpro has transformed our workforce management. We've seen 40% improvement in project completion rates.",
      author: "Maria Santos",
      position: "HR Director",
      result: "40% improvement in project completion rates",
      description: "TechCorp Philippines leveraged Localpro's platform to streamline their workforce management, resulting in significant operational improvements.",
      metrics: [
    ...
    },
    {
      ...
      quote: "The quality of skilled workers we get through Localpro is exceptional. Our client satisfaction has increased significantly.",
      author: "John Dela Cruz",
      position: "Operations Manager",
      result: "Exceptional worker quality and client satisfaction",
      description: "GreenBuild Solutions found reliable skilled workers through Localpro, leading to improved project outcomes and client relationships.",
      metrics: [
    ...
    },
    {
      ...
      quote: "Localpro's platform has streamlined our hiring process. We can now find qualified professionals in half the time.",
      author: "Ana Rodriguez",
      position: "CEO",
      result: "50% faster hiring process",
      description: "Metro Services Inc optimized their recruitment process using Localpro's platform, significantly reducing time-to-hire.",
      metrics: [
  ...
  const partnerTestimonials = [
    {
      ...
      rating: 5,
      testimonial: "Localpro has been instrumental in scaling our business. The platform connects us with skilled workers who deliver quality results.",
      avatar: "CM",
      verified: true,
      role: "CEO"
    },
    {
      ...
      rating: 5,
      testimonial: "The partnership with Localpro has opened new opportunities for our company. The support team is excellent and always responsive.",
      avatar: "LC",
      verified: true,
