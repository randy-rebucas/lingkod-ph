                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-b border-border/50">
                            ...
                            <TableHead className="font-semibold">{t('applications')}</TableHead>
                    ...
                    <TableBody>
                        {filteredJobs.length > 0 ? filteredJobs.map(job => (
                            <TableRow key={job.id} className="hover:bg-muted/30 transition-colors border-b border-border/30">
                                ...
                                <TableCell>{job.category || t('na')}</TableCell>
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            >
                                                ...
                                                {job.status === 'Open' ? t('close') : t('reopen')}
                                            </DropdownMenuItem>
                                            <DropdownMenuSeparator />
                                            <AlertDialog>
                                ...
                                <TableCell colSpan={6} className="text-center h-32">
                                    <div className="flex flex-col items-center justify-center space-y-3">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-muted-foreground">{t('noJobsMatchSearch')}</p>
                                        </div>
                                    </div>
                                </TableCell>
                            </TableRow>
